...
# Default-enable external camera rendering for teleoperation recording. Set programmatically
# because the ``--enable_cameras`` CLI flag was removed in Isaac Lab 3.0 (see #6656); AppLauncher
