...
.. code-block:: bash
   ...
   uv run --extra teleop --extra isaacsim python -c "from isaaclab_teleop import check_system_requirements; print(check_system_requirements().format_table())"
...
.. tab-set::
   ...
   .. tab-item:: uv (Recommended)
      ...
      .. code-block:: bash
         ...
         uv run --extra teleop --extra isaacsim isaaclab teleop run \
   ...
   .. tab-set::
      ...
      .. tab-item:: uv (Recommended)
         ...
         .. code-block:: bash
            ...
            cp $(uv run --extra teleop --extra isaacsim python -c \
...
.. tab-set::
   ...
   .. tab-item:: uv (Recommended)
      ...
      .. code-block:: bash
         ...
         uv run --extra teleop --extra isaacsim isaaclab teleop record \
           --task IsaacContrib-PickPlace-Locomanipulation-G1-Abs \
           --num_demos 5 \
